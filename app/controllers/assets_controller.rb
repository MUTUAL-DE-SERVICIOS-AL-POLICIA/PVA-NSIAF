  ...
  private
    ...
    def asset_params
      if action_name == 'create'
        ...
        params.require(:asset).permit(:code, :detalle, :medidas, :material, :color, :marca, :modelo, :serie, :precio, :proceso, :observaciones, :auxiliary_id, :user_id, :barcode, :state, :seguro)
      else
        params.require(:asset).permit(:code, :detalle, :medidas, :material, :color, :marca, :modelo, :serie, :precio, :proceso, :observaciones, :auxiliary_id, :barcode, :state, :derecognised, :description_decline, :reason_decline, :decline_user_id, :seguro)
      end
    end
end
